...
const toastVariants = cva(
    [
        "group pointer-events-auto relative flex items-center justify-between",
        "space-x-2 overflow-hidden rounded-3xl border p-4 pl-6 pr-10 shadow-lg transition-all",
