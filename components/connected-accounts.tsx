            ...
            <CardContent>
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        {!user?.email ? (
                            <Button onClick={() => linkEmail()}>Connect</Button>
                        ) : (
                            <Button onClick={() => unlinkEmail(user?.email?.address ?? "")}>
                                Disconnect
                            </Button>
                        )}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {!user?.phone ? (
                            <Button onClick={() => linkPhone()}>Connect</Button>
                        ) : (
                            <Button onClick={() => unlinkPhone(user?.phone?.number ?? "")}>
                                Disconnect
                            </Button>
                        )}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {!user?.wallet ? (
                            ...
                            <Button onClick={() => unlinkWallet(user?.wallet?.address ?? "")}>
                                Disconnect
                            </Button>
                        )}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {!user?.discord ? (
                            ...
                            <Button onClick={() => unlinkDiscord(user?.discord?.username ?? "")}>
                                Disconnect
                            </Button>
                        )}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {!user?.twitter ? (
                            <Button onClick={() => linkTwitter()}>Connect</Button>
                        ) : (
                            <Button onClick={() => unlinkTwitter(user?.twitter?.username ?? "")}>
                                Disconnect
                            </Button>
                        )}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {!user?.google ? (
                            <Button onClick={() => linkGoogle()}>Connect</Button>
                        ) : (
                            <Button onClick={() => unlinkGoogle(user?.google?.email ?? "")}>
                                Disconnect
                            </Button>
                        )}
                    </div>
